...
class PricingSetting extends Model
{
    ...
    protected $casts = [
        ...
        'delivery_small_fee' => 'integer',
        'delivery_medium_fee' => 'integer',
        'delivery_large_fee' => 'integer',
        'delivery_fragile_fee' => 'integer',
        'delivery_weight_threshold_kg' => 'integer',
        'delivery_extra_kg_fee' => 'integer',
